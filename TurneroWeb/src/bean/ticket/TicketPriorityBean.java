...
@ViewScoped
@Named
public class TicketPriorityBean implements Serializable {
	...
	public void setTicketPriorityFacadeLocal(TicketPriorityFacadeLocal objectFacadeLocal) {
